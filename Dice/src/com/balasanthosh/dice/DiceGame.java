...
public class DiceGame {
	 ...
	 * @return
	 */
	public static <String, Integer extends Comparable<? super Integer>> List<Entry<String, Integer>> entriesSortedByValues(Map<String, Integer> map) {
				...
				if (!missTheRound.contains(nowPlaying)) {
					...
					if (pointsTable.get(nowPlaying).intValue() >= finalPoints) {
						System.out.println("*********!!!!" + nowPlaying
								+ " Congrats you attained the maximum points.Your rank is "+rank +".Thanks for Playing******");
